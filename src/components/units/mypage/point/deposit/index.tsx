    ...
    <WrapperWidth800px>
      ...
      <S.NoteBox>
        <S.NoteList>
          ...
          결제 후 영업일 기준으로 5일 안에 결제 취소한 경우에 가능합니다. 포인트
          충전 내역에서 ‘결제 취소’를 클릭하여 포인트 결제를 취소할 수 있습니다.
          결제사 정책에 따라 카드 승인 취소 또는 대금이 고객님의 계좌로
          입금되기까지 영업일 기준으로 최대 5일이 소요될 수 있습니다.
        </S.NoteList>
        <S.NoteList>
        ...
        <S.NoteList>
          ...
          차감됩니다. 환불한 금액은 영업일 기준으로 5일 안에 환불 계좌로 입금해
          드립니다.
        </S.NoteList>
        <S.NoteList>
          미성년자는 포인트를 충전하기 전에 부모 등 법정 대리인의 동의를 받아야
          합니다. 법정대리인이 동의하지 않으면 미성년자 본인 또는 법정대리인이
          이용 계약을 취소할 수 있습니다.
        </S.NoteList>
        <S.NoteList>
