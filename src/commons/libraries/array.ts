...
export const mainVisualItem = [
  ...
  },
  {
    ...
    content:
      "그녀가 좋아하는 맥 아이템으로 가득한 새로운 리미티드 컬렉션을 확인해보세요!",
    color: "#fff",
    url: "/collections/mac-lisa"
  },
  {
    ...
    content:
      "지금 바로 맥 비바 글램 케이스에 담긴 아이코닉 컬러들을 확인해보세요!",
    color: "#fff"
  },
  {
  ...
  },
  {
    ...
    title: "맥 루나 뉴이어 컬렉션",
    content:
      "흑호랑이의 해를 맞이하여, 행운과 강인한 기운을 선사할 2022 맥 루나 뉴이어 컬렉션 ‘루나 럭 (Lunar Luck)’을 확인해보세요!",
    color: "#fff",
    url: "/collections/lunar-luck/"
  }
];
...
export const collectionLisa = {
  ...
  main: {
    ...
    mainContent:
      "리사가 가장 사랑하는 것에 영감을 받아 탄생한 NEW 컬러와 그녀가 좋아하는 맥 아이템으로 가득한 새로운 리미티드 컬렉션을 소개합니다.",
    mainItem: [
      {
  ...
  flex: {
    ...
    itemWrap: [
      {
        content: "맥 바이 엘 아이 섀도우 X 12 / MAC X L COLLECTION",
        url: "",
        background: "#c5bdee"
      },
      {
        content: "파우더 키스 리퀴드 립컬러 / MAC X L COLLECTION",
        url: "",
        background: "#514591"
      }
    ]
  ...
  banner: {
    ...
    bannerItem: [
      "“제가 가장 좋아하는 에델바이스 꽃이 새겨져 있고 부드러운 피치 핑크 빛으로 피부를 연출해줘요!”",
      "“#리듬 ‘앤’ 로지스는 제가 가장 좋아하는 것들인 ‘음악‘과 ‘꽃’에 영감을 받아 만들어진 이름이에요.”",
      "“제가 가장 좋아하는 것들을 모아 컬러를 만들고 이름을 지어 더 특별한 섀도우 팔레트에요!”",
      "“제 룩의 시그니처인 캣츠 아이를 완성해주는 아이라이너는 제 메이크업에서 빠질 수 없죠!”"
    ]
  },
  lookbook: {
    lookbookTitleT: "GET THE LISA",
    lookbookTitleB: "LOOK",
    lookbookDeco: "#9d78c3",
    lookBookL: {
  ...
  full: {
    fullBackground: "#151540",
    highlight: "#F0C771",
    fullTitle: "리사가 가장 사랑하는 제품을 만나보세요!",
    fullContent: "",
    fullItem: [
      {
        img: "https://storage.googleapis.com/cometes-storage/thumbnail/FACE/%EB%A6%AC%EC%82%AC%20%EC%97%91%EC%8A%A4%ED%8A%B8%EB%9D%BC%ED%94%BC%EB%8B%88%EC%89%AC.png",
  ...
  video: {
    videoTitleT: "MAC LOVES LISA",
    videoTitleB: "LISA LOVES MAC",
    videoContent:
...
export const collectionLunar = {
  ...
  main: {
    ...
    mainContent:
      "루나 럭 컬렉션은 2022년을 상징하는 호랑이와 부, 행운, 재물 등을 상징하는 꽃 중의 왕 작약을 모티브로 새해에 모든 좋은 일들이 가득하기를 기원하는 마음을 담았습니다.",
    mainItem: [
      {
        img: "https://storage.googleapis.com/cometes-storage/thumbnail/EYE/%EB%A3%A8%EB%82%98%20%EC%84%80%EB%8F%84%EC%9A%B0.png",
        title: "아이 섀도우 바이 나인: 메이드 마이 포춘 / 루나 럭"
      },
      {
        img: "https://storage.googleapis.com/cometes-storage/thumbnail/LIP/%EB%A3%A8%EB%82%98%20%ED%8C%8C%EC%9A%B0%EB%8D%94%ED%82%A4%EC%8A%A4%20%EB%A6%AC%ED%80%B4%EB%93%9C.png",
        title: "파우더 키스 리퀴드 립컬러 / 루나 럭"
      },
      {
        img: "https://storage.googleapis.com/cometes-storage/thumbnail/LIP/%EB%A3%A8%EB%82%98%20%ED%8C%8C%EC%9A%B0%EB%8D%94%ED%82%A4%EC%8A%A4%20%EB%A6%BD%EC%8A%A4%ED%8B%B1.png",
        title: "파우더 키스 립스틱 / 루나 럭"
      },
      {
        img: "https://storage.googleapis.com/cometes-storage/thumbnail/FACE/%EB%A3%A8%EB%82%98%20%EC%97%91%EC%8A%A4%ED%8A%B8%EB%9D%BC%EB%94%94%EB%A9%98%EC%85%98.png",
        title: "엑스트라 디멘션 스킨피니쉬 / 루나 럭"
      }
    ]
  }
};
...
export const collectionHoliday = {
  ...
  main: {
    ...
    mainTitle: "맥 2023 홀리데이 컬렉션",
    mainContent:
      "새하얀 눈과 얼음으로 뒤덮여 보석처럼 반짝이는 은빛의 맥 홀리데이 한정판 컬렉션을 만나보세요.",
    mainItem: [
      {
  ...
  video: {
    videoTitleT: "BIZARRE BLIZZARD",
    videoTitleB: "MAC HOLIDAY 2023",
    videoContent:
